...
| `tokens/README.md` | Specyfikacja artu żetonów — kadr, rozmiary, skala, **format (WEBP)** |
...
- **Binary assets are forever on a public repo (2026-09-20):** 25 token PNGs were about to be committed at 39.5 MB; the same art as WEBP q92 is 4.9 MB, with a byte-identical alpha bounding box. Nobody notices this at review time because the diff just says "25 files added". Check asset size and format *before* the first commit that introduces them — after a push, shrinking them means rewriting public history. See `tokens/README.md`.
