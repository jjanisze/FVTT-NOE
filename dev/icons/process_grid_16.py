...
IN_PATH = os.path.join(os.path.dirname(__file__), "in", "Weapons_Resize_16.png")
OUT_DIR = os.path.join(os.path.dirname(__file__), "out")
TARGET_SIZE = (256, 256)

# 3x3 grid, row-major order provided by user:
# [1] Piledriver improvised war hammer
# [2] Improvised halberd
# [3] Cobra crossbow
# [4] Smoke Grenade
# [5] Mustard Gas Grenade
# [6] Flashbang Grenade
