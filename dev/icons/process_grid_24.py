...
IN_PATH = os.path.join(os.path.dirname(__file__), "in", "Weapons_Resize_24.png")
ICONS_BASE = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "icons")
TARGET_SIZE = (256, 256)

SLOTS = [
    ("antybiotyk",              "items/drugs"),   # 1: antibiotic capsules — Antybiotyk
    ("anestix",                 "items/drugs"),   # 2: two syringes — Anestix
    ("tornado",                 "items/drugs"),   # 3: crushed gemstones — Tornado
    ("neodrugs",                "items/drugs"),   # 4: pocket inhaler — Neodrugs
    ("narkotyki_latwe",         "items/drugs"),   # 5: dried packed plant — Narkotyki łatwe
    ("narkotyki_przedwojenne",  "items/drugs"),   # 6: metallic ziplock bag — Narkotyki przedwojenne
    ("alkohol_tani",            "items/drugs"),   # 7: cheap bottles — Alkohol tani
    ("alkohol_markowy",         "items/drugs"),   # 8: fancy bottles — Alkohol markowy
    ("cygaro",                  "items/drugs"),   # 9: cigar — Cygaro
]
