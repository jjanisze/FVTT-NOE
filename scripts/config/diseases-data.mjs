...
import { KOBALT_DISEASES } from "../wkk/config/diseases-data.mjs";

// Re-exported for back-compat: consumers that only care about "the disease catalog"
// (e.g. scripts/tests/choroby.test.mjs) shouldn't need to know WKK content lives in a
// separate file. The definition itself is WKK-owned — see scripts/wkk/config/diseases-data.mjs.
export { KOBALT_DISEASES };
